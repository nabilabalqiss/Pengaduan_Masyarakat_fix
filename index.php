...
<head>
    ...
    <title>Dinas Kependudukan dan Pencatatan Sipil Bireuen</title>
...
<body>
    ...
    <div class="shadow">
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="">
                        <img alt="Brand" src="images/logo_bireuen.jpeg" width="50" height="50" class="d-inline-block align-top" alt="">
                    </a>
                </div>
        ...
        <div id="mainCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img src="images/kantor-bupati-bireun.jpg" alt="...">
                    <div class="carousel-caption welcome">
                        <h2 class="animated bounceInRight">Selamat Datang</h2>
                        <h3 class="animated bounceInLeft">Website Pengaduan Masyarakat Dinas Kependudukan dan Pencatatan Sipil Bireuen</h3>
                    </div>
                </div>
                <div class="item">
                    <img src="images/penjabat.jpg" alt="...">
                    <div class="carousel-caption">
                        <h2 class="animated bounceInDown">Pejabat</h2>
                    </div>
                </div>
                <div class="item">
                    <img src="images/jam_pelayanan1.png" alt="...">
                    <div class="carousel-caption">
        ...
        <footer class="footer text-center">
            <div class="row">
                <div class="col-md-0 mb-0 mb-lg-0">
                    ...
                    <div class="col-md-0 mb-0 mb-lg-0">
                        ...
                        <p class="mb-0">
                            031-3095331 <br>
                            dispendukcapil@bireuenkab.go.id <br>
                            dispendukcapil.bireuen@gmail.com
                        </p>
                    </div>
                </div>
        </footer>
