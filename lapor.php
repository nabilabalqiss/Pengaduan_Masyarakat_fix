...
<head>
    ...
    <title>Lapor | Dinas Kependudukan dan Pencatatan Sipil Bireuen</title>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="telpon" name="telpon" placeholder="No Telepon" value="<?= @$_GET['telpon'] ?>" required>
                                </div>
